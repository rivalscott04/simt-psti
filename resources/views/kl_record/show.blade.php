                ...
                <div class="ibox ">
                    ...
                    <div class="ibox-content">
                        ...
                        <div class="text-center">
                            ...
                            <!-- Jika tugas diterima -->
                            <form action="{{ route('kl.accept', $tugas->id_tugas) }}" method="post"
                            ...
                            <div class="modal inmodal" id="tolak" tabindex="-1" role="dialog" aria-hidden="true">
                                <div class="modal-dialog">
                                    <div class="modal-content animated bounceInRight">
                                        ...
                                        <form action="{{ route('kl.reject', $tugas->id_tugas) }}" method="post">
                                            @csrf
                            ...
                            <div class="modal inmodal" id="teruskan" tabindex="-1" role="dialog" aria-hidden="true">
                                <div class="modal-dialog">
                                    <div class="modal-content animated bounceInRight">
                                        ...
                                        <form action="{{ route('kl.forward', $tugas->id_tugas) }}" method="post"
                                            style="display: inline;">
                                            @csrf
                                            <div class="modal-body">
                                                <!-- <label>
