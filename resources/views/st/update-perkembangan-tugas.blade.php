    ...
    <div class="wrapper wrapper-content  animated fadeInRight">
        <div>
            <p style="font-weight: bold;">
                Status Tugas :
                &nbsp;
                @if ($riwayat_penerimaan->keterangan == 'incomplete')
            <form action="{{ route('st.updateStatusRiwayatPenerimaan', $riwayat_penerimaan->id_tugas) }}"
                method="post">
                @csrf
                <button class="btn btn-xs btn-warning " type="submit" onclick="return confirm('Apakah anda yakin?')">
                    incomplete
                </button>
            </form>
            @else
            ...
            <div class="col-md-5">
                <div class="ibox">
                    <div class="ibox-content">
                        ...
                        <form action="{{ route('st.addTodoList', $id_tugas ) }}" method="post">
                            @csrf
                                    ...
                                    <div class="row">
                                        <div class="col-sm-12">
                                            <div class="text-right">
                                                <form
                                                    action="{{ route('st.updateStatusPerkembangan', $perkembangan->id_perkembangan) }}"
                                                    method="post">
                                                    @csrf
                                                    <button class="btn btn-xs btn-info btn-outline" type="submit" onclick="return confirm('Apakah anda yakin?')">
                                                        In progress
                                                    </button>
                                                </form>
                                            </div>
                ...
                <div class="ibox">
                    <div class="ibox-content">
                        ...
                        <ul class="sortable-list connectList agile-list" id="todo">
                            ...
                            <li class="success-element" id="task1">
                                ...
                                <div class="agile-detail">
                                    <div class="row">
                                        <div class="col-sm-12">
                                            <div class="text-right">
                                                <a href="#" class="float-right btn btn-xs btn-primary">Selesai</a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            </li>
                            @elseif ($perkembangan->keterangan == 'menunggu_konfirmasi')
                            <li class="warning-element" id="task1">
                                ...
                                <div class="agile-detail">
                                    <div class="row">
                                        <div class="col-sm-12">
                                            <div class="text-right">
                                                <a href="#" class="float-right btn btn-xs btn-warning">Menunggu
                                                    Konfirmasi</a>
                                            </div>
                                        </div>
                                    </div>
                            ...
                            @elseif ($perkembangan->keterangan == 'revisi')
                            <li class="danger-element" id="task1">
                                {{ $perkembangan->todo_list }}
                                <div class="agile-detail">
                                    <div class="row">
                                        <div class="col-sm-12">
                                            ...
                                            <div class="text-right">
                                                <form
                                                    ...
                                                    method="post">
                                                    @csrf
                                                    <button class="btn btn-xs btn-danger" type="submit" onclick="return confirm('Apakah anda yakin?')">
                                                        Revisi
                                                    </button>
                                                </form>
                                            </div>
            ...
            <div class="col-md-12">
                <div class="ibox">
                    <div class="ibox-content">
                        ...
                        <form action="{{ route('st.updateLampiranPerkembangan', $id_tugas ) }}"
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-8">
                                    <select class="select2_demo_3 form-control" name="todo_list" required>
                                        @foreach($perkembangans as $perkembangan)
                                        <option value="{{ $perkembangan->todo_list }}">{{ $perkembangan->todo_list }}
                                        </option>
                                        @endforeach
                                    </select>
                                    <br>
