                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td nowrap>
                                            {{ $dosen->nama_pengguna }}
                                            &nbsp;
                                            <a href="{{ route('k.detailStatistikTugas', ['nama_dosen_staf' => $dosen->nama_pengguna])}}"
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td nowrap>
                                            {{ $staf->nama_pengguna }}
                                            &nbsp;
                                            <a href="{{ route('k.detailStatistikTugas', ['nama_dosen_staf' => $staf->nama_pengguna])}}"
                                                class="btn btn-xs btn-success btn-outline">
                                                <i class="fa fa-external-link"></i>
                                                &nbsp;
                                                Lihat Detail
