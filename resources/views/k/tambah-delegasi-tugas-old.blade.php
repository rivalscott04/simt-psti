...
<body>
                    ...
                    <div class="col-md-12">
                        <div class="ibox ">
                            ...
                            <div class="ibox-content">
                                <form action="/k/delegasi-tugas" enctype="multipart/form-data" method="post"
                                            ...
                                            <div class="form-group row"> <label class="col-sm-4 label1"
                                                ...
                                                <div class="col-sm-8 col-md-5">
                                                    <div class="form-group" id="data_1">
                                                        ...
                                                        <small class="text-muted"> <b>Tenggat waktu pengerjaan (tanggal)</b> </small>
                                                    </div>
                                                </div>
                                            </div>
    ...
    <script>
        $(document).ready(function () {
            ...
            //     let id = $('#selectRole').val();

            //     $("#selectUser").select2({
            //         placeholder: 'Pilih Nama',
            //         ajax: {
            //             url: "{{url('selectUser')}}/" + id,
            //             processResults: function ({ data }) {
            //                 return {
            //                     results: $.map(data, function (item) {
            //                         return {
