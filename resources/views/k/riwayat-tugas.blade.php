                                ...
                                <div class="vertical-timeline-content">
                                    ...
                                    <div>
                                        ...
                                        <div>
                                            ...
                                            <a href="{{ route('k.download', ['tugas' => $riwayat->lampiran]) }}"
                                            ...
                                            <div class="modal inmodal" id="revisi" tabindex="-1" role="dialog"
                                                ...
                                                <div class="modal-dialog">
                                                    <div class="modal-content animated bounceInRight">
                                                        ...
                                                        <form
                                                            action="{{ route('k.revisi', $riwayat->id_perkembangan) }}"
                                                            method="post">
                                                            @csrf
                                        ...
                                        <div>
                                            <form
                                                action="{{ route('k.perkembangan.selesai', $riwayat->id_perkembangan) }}"
                                                method="post">
                                                @csrf
