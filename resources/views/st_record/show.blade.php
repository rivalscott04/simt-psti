    ...
    <div class="row wrapper border-bottom white-bg page-heading">
        <div class="col-lg-10">
            ...
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item">
                    <a href="/st/tugas-masuk">Tugas Masuk</a>
                </li>
                ...
                <div class="ibox ">
                    ...
                    <div class="ibox-content">
                        <div class="row">
                            <div class="col-md-6">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-8">
                                        <a href="{{ route('st.download', ['tugas' => $tugas->lampiran]) }}">
                        ...
                        <div class="text-center">
                            ...
                            <!-- Jika tugas diterima -->
                            <form action="{{ route('st.accept', $tugas->id_tugas) }}" method="post"
                            ...
                            <div class="modal inmodal" id="tolak" tabindex="-1" role="dialog" aria-hidden="true">
                                <div class="modal-dialog">
                                    <div class="modal-content animated bounceInRight">
                                        ...
                                        <form action="{{ route('st.reject', $tugas->id_tugas) }}" method="post">
                                            @csrf
                            ...
                            <div class="modal inmodal" id="teruskan" tabindex="-1" role="dialog" aria-hidden="true">
                                <div class="modal-dialog">
                                    <div class="modal-content animated bounceInRight">
                                        ...
                                        <form action="{{ route('st.forward', $tugas->id_tugas) }}" method="post"
                                            style="display: inline;">
                                            @csrf
                                            <div class="modal-body">
                                                <label>
                            ...
                            <!-- <form action="/st/detail-tugas-masuk" method="post">
                                <button type='submit' class="btn btn-primary"
                                    onclick=" return confirm('Apakah anda yakin?')">
                                    Terima
                                </button> -->
