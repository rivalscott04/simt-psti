...
<div id="page-wrapper" class="gray-bg">
    ...
    <div class="wrapper wrapper-content animated fadeInRight">
            ...
            <div class="col-lg-12">
                <div class="ibox">
                    ...
                    <div class="ibox-content">
                        <form action="/ah/tugas" method="get">
                            <div class="row">
                                <div class="col-lg-3">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td>
                                            ...
                                            @if ($tugas->keterangan == 'incomplete')
                                            <a href="{{ route('ah.updatePerkembangan', ['id_tugas' => $tugas->id_tugas] ) }}"
        ...
        <!-- Daftar Tugas Diterima yang Merupakan Tugas Terusan -->
        <div class="row">
            <div class="col-lg-12">
                <div class="ibox">
                    <div class="ibox-title">
