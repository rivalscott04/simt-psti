            ...
            <div class="col-lg-12">
                <div class="ibox">
                    ...
                    <div class="ibox-content">
                        <form action="/ah/delegasi-tugas" method="get">
                            <div class="row">
                                <div class="col-lg-3">
                                ...
                                <div class="col-md-6 col-lg-8" style="padding-top: 7px; padding-left: 7px;">
                                    <br />
                                    &nbsp;
                                    <a href="/ah/tambah-delegasi-tugas" class="btn btn-primary">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <a href="{{ route('ah.riwayatTugas', $tugas->id_tugas)}}"
                                            ...
                                            <a href="{{ route('ah.edit', $tugas->id_tugas) }}"
                                                class="btn btn-xs btn-primary btn-outline">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <a href="{{ route('ah.riwayatTugas', $tugasTeruskan->id_tugas) }}"
                                                class="btn btn-xs btn-primary btn-outline">
                                                <i class="fa fa-external-link"></i>
                                                &nbsp;Riwayat
                                            </a>
                                            ...
                                            <a href="{{ route('ah.show', ['tugas' => $tugasTeruskan->id_tugas] ) }}"
