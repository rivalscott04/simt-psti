...
<div id="page-wrapper" class="gray-bg">
    ...
    <div class="wrapper wrapper-content  animated fadeInRight">
        <div>
            ...
            <form action="{{ route('ah.updateStatusRiwayatPenerimaan', $riwayat_penerimaan->id_tugas) }}"
                method="post">
                @csrf
            ...
            <div class="col-md-5">
                <div class="ibox">
                    <div class="ibox-content">
                        ...
                        <form action="{{ route('ah.addTodoList', $id_tugas ) }}" method="post">
                            @csrf
                                    ...
                                    <div class="row">
                                        <div class="col-sm-12">
                                            <div class="text-right">
                                                <form
                                                    action="{{ route('ah.updateStatusPerkembangan', $perkembangan->id_perkembangan) }}"
                                                    method="post">
                                                    @csrf
            ...
            <div class="col-md-12">
                <div class="ibox">
                    <div class="ibox-content">
                        ...
                        <form action="{{ route('ah.updateLampiranPerkembangan', $id_tugas ) }}"
