            ...
            <div class="col-lg-12">
                <div class="ibox">
                    ...
                    <div class="ibox-content">
                        <form role="form" action="/ah/tugas-masuk" method="get">
                            <div class="row">
                                <div class="col-lg-3">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <a href="{{ route('ah.show', ['tugas' => $tugas->id_tugas] ) }}"
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td nowrap="">
                                            ...
                                            <a href="/ah/detail-tugas-masuk" class="btn btn-xs btn-primary btn-outline">
                                                <i class="fa fa-external-link"></i>
                                                &nbsp;Buka
                                            </a>
                                        </td>
