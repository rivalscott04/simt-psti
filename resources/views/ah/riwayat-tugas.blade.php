                                ...
                                <div class="vertical-timeline-content">
                                    ...
                                    <div>
                                        ...
                                        <div>
                                            ...
                                            <a href="{{ route('ah.download', ['tugas' => $riwayat->lampiran]) }}"
                                            ...
                                            <div class="modal inmodal" id="revisi" tabindex="-1" role="dialog"
                                                ...
                                                <div class="modal-dialog">
                                                    <div class="modal-content animated bounceInRight">
                                                        ...
                                                        <form
                                                            action="{{ route('ah.revisi', $riwayat->id_perkembangan) }}"
                                                            method="post">
                                                            @csrf
                                        ...
                                        <div>
                                            <form
                                                action="{{ route('ah.perkembangan.selesai', $riwayat->id_perkembangan) }}"
                                                method="post">
                                                @csrf
