                ...
                <div class="ibox ">
                    ...
                    <div class="ibox-content">
                        <div class="row">
                            <div class="col-md-6">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-8">
                                        <a href="{{ route('s.download', ['tugas' => $tugas->lampiran]) }}">
                        ...
                        <div class="text-center">
                            ...
                            <!-- Jika tugas diterima -->
                            <form action="{{ route('s.accept', $tugas->id_tugas) }}" method="post"
                            ...
                            <div class="modal inmodal" id="tolak" tabindex="-1" role="dialog" aria-hidden="true">
                                <div class="modal-dialog">
                                    <div class="modal-content animated bounceInRight">
                                        ...
                                        <form action="{{ route('s.reject', $tugas->id_tugas) }}" method="post">
                                            @csrf
                            ...
                            <div class="modal inmodal" id="teruskan" tabindex="-1" role="dialog" aria-hidden="true">
                                <div class="modal-dialog">
                                    <div class="modal-content animated bounceInRight">
                                        ...
                                        <form action="{{ route('s.forward', $tugas->id_tugas) }}" method="post"
                                            style="display: inline;">
                                            @csrf
                                            <div class="modal-body">
                                                <label>
