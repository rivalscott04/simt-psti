            ...
            <div class="col-md-5">
                <div class="ibox">
                    <div class="ibox-content">
                        ...
                        <form action="{{ route('s.addTodoList', $id_tugas ) }}" method="post">
                            @csrf
                                    ...
                                    <div class="row">
                                        <div class="col-sm-12">
                                            <div class="text-right">
                                                <form
                                                    action="{{ route('s.updateStatusPerkembangan', $perkembangan->id_perkembangan) }}"
                                                    method="post">
                                                    @csrf
            ...
            <div class="col-md-12">
                <div class="ibox">
                    <div class="ibox-content">
                        ...
                        <form action="{{ route('s.updateLampiranPerkembangan', $id_tugas ) }}"
