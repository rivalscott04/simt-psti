                            ...
                            <table class="table table-hover table-bordered">
                                <thead>
                                    <tr>
                                        ...
                                        <th colspan="2" class="text-center" style="width: 100px;" nowrap>Jumlah Tugas
                                        </th>
                                    </tr>
                                    <tr>
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td nowrap>
                                            {{ $dosen->nama_pengguna }}
                                            &nbsp;
                                            <a href="{{ route('s.detailStatistikTugas', ['nama_dosen_staf' => $dosen->nama_pengguna])}}"
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td nowrap>
                                            {{ $staf->nama_pengguna }}
                                            &nbsp;
                                            <a href="{{ route('s.detailStatistikTugas', ['nama_dosen_staf' => $staf->nama_pengguna])}}"
                                                class="btn btn-xs btn-success btn-outline">
                                                <i class="fa fa-external-link"></i>
                                                &nbsp;
                                                Lihat Detail
