    ...
    <div class="row wrapper border-bottom white-bg page-heading">
        <div class="col-lg-10">
            ...
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item">
                    <a href="/kl/tugas-masuk">Tugas Masuk</a>
                </li>
                ...
                <div class="ibox ">
                    ...
                    <div class="ibox-content">
                        <div class="row">
                            <div class="col-md-6">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-8">
                                        <a href="{{ route('kl.download', ['tugas' => $tugas->lampiran]) }}">
                        ...
                        <div class="text-center">
                            ...
                            <!-- Jika tugas diterima -->
                            <form action="{{ route('kl.acceptTeruskan', $tugas->id_tugas) }}" method="post"
                            ...
                            <div class="modal inmodal" id="tolak" tabindex="-1" role="dialog" aria-hidden="true">
                                <div class="modal-dialog">
                                    <div class="modal-content animated bounceInRight">
                                        ...
                                        <form action="{{ route('kl.rejectTeruskan', $tugas->id_tugas) }}" method="post">
                                            @csrf
                            ...
                            <div class="modal inmodal" id="teruskan" tabindex="-1" role="dialog" aria-hidden="true">
                                <div class="modal-dialog">
                                    <div class="modal-content animated bounceInRight">
                                        ...
                                        <form action="{{ route('kl.forwardTeruskan', $tugas->id_tugas) }}" method="post"
                                            style="display: inline;">
                                            @csrf
                                            <div class="modal-body">
                                                <!-- <label>
                                                ...
                                                <br><br>
                                                <select style="width: 100%;" id="select2" name="tujuan" class="select2_demo_3 form-control"
                                                    required>
                                                </select>
                            ...
                            <!-- <form action="/kl/detail-tugas-masuk" method="post">
                                <button type='submit' class="btn btn-primary"
                                    onclick=" return confirm('Apakah anda yakin?')">
                                    Terima
                                </button> -->
