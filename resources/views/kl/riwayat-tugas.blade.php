                    ...
                    <div class="ibox-content" id="ibox-content">
                        ...
                        <div id="vertical-timeline" class="vertical-container dark-timeline center-orientation">
                            ...
                            <div class="vertical-timeline-block">
                                ...
                                @elseif ($riwayat->keterangan == 'menunggu_konfirmasi')
                                <div class="vertical-timeline-icon bg-warning">
                                    <i class="fa fa-clock-o"></i>
                                </div>
                                @elseif ($riwayat->keterangan == 'revisi')
                                ...
                                <div class="vertical-timeline-content">
                                    ...
                                    <div>
                                        @if ($riwayat->keterangan == 'menunggu_konfirmasi')
                                        <div>
                                        ...
                                        <div>
                                            ...
                                            <a href="{{$riwayat->url}}" class="btn btn-xs btn-info">
                                            ...
                                            <a href="{{ route('kl.download', ['tugas' => $riwayat->lampiran]) }}"
                                        ...
                                        <div>
                                            ...
                                            <div class="modal inmodal" id="revisi" tabindex="-1" role="dialog"
                                                aria-hidden="true">
                                                <div class="modal-dialog">
                                                    <div class="modal-content animated bounceInRight">
                                                        <div class="modal-header">
                                                            <h4 class="modal-title">Ajukan Revisi</h4>
                                                        </div>
                                                        <form
                                                            action="{{ route('kl.revisi', $riwayat->id_perkembangan) }}"
                                                            method="post">
                                                            @csrf
                                                            <div class="modal-body">
                                                                <div class="form-group">
                                                                    <label for="alasan_revisi">Alasan Revisi</label>
                                                                    <textarea class="form-control" name="alasan_revisi"
                                        ...
                                        <div>
                                            <form
                                                action="{{ route('kl.perkembangan.selesai', $riwayat->id_perkembangan) }}"
                                                method="post">
                                                @csrf
                                                <button class="btn btn-xs btn-primary" type="submit" onclick="return confirm('Apakah anda yakin?')">
                                                    <i class="fa fa-send-o"></i>
                                                    &nbsp;
                                                    Terima
                                                </button>
