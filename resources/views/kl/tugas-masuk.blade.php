            ...
            <div class="col-lg-12">
                <div class="ibox">
                    ...
                    <div class="ibox-content">
                        <form role="form" action="/kl/tugas-masuk" method="get">
                            <div class="row">
                                <div class="col-lg-3">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <a href="{{ route('kl.show', ['tugas' => $tugas->id_tugas] ) }}"
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td nowrap="">
                                            ...
                                            <a href="/kl/detail-tugas-masuk" class="btn btn-xs btn-primary btn-outline">
                                                <i class="fa fa-external-link"></i>
                                                &nbsp;Buka
                                            </a>
                                        </td>
                ...
                <div class="ibox">
                    ...
                    <div class="ibox-content">
                        <form role="form" action="/kl/tugas-masuk" method="get">
                            <div class="row">
                                <div class="col-lg-3">
                                    <label for="searchTeruskan" style="font-weight: bold;">Pengirim / Keterangan</label>
                                    <div class="input-group">
                                        <span class="input-group-addon">
                                            <i class="fa fa-search"></i>
                                        </span>
