...
<head>
    ...
    <title>Daftar Tugas | Sistem Informasi Monitoring Tugas</title>
...
<body id="page-top" class="landing-page no-skin-config bg-white">
    ...
    <section id="daftar-tugas" class="white-section">
        <div class="container">
            <div class="row m-b-lg">
                <div class="col-lg-12 text-center" style="padding-top: 100px;">
                    <!-- <div class="navy-line"></div> -->
                    <h1>Jumlah
                        <span class="text-danger" style="font-weight:400;">Tugas Seluruh Dosen dan Staf</span>
                    </h1>
                </div>
            </div>
