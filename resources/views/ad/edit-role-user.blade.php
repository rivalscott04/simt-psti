            ...
            <div class="col-md-12">
                <div class="ibox ">
                    ...
                    <div class="ibox-content">
                        <form action="{{ route('ad.update', ['id' => $roleUser->id] )}}"
                            method="post" class="form-horizontal">
                            @csrf
                            <div class="row">
                                <div class="col-lg-6">

                                    <!-- <div class="form-group row"><label>Nama Pengguna</label>
                                        <select style="width: 100%;" id="nama_pengguna" name="nama_pengguna"
                                            class="select2_demo_3 form-control" required>
                                        </select>
                                    </div> -->
                                    <!-- <div class="form-group row"><label>Role</label>
