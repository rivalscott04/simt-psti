...
class DelegasiTugasAdHoc extends Controller
{
    ...
    public function tugasMasuk(Request $request)
    {
        ...
        return view('ah/tugas-masuk', compact('semuaTugasTeruskan', 'jumlahTugasTeruskan', 'semuaTugas', 'jumlahTugas', 'jumlahTugasMasuk', 'nama_pengguna', 'role', 'title', 'nama_pengirim'));
    }
    ...
    public function show(Request $request, Tugas $tugas)
    {
        ...
        return view('ah.show', compact('jumlahTugasMasuk', 'tugas', 'title', 'nama_pengguna', 'role', 'nama_hari', 'tanggal', 'jam'));
    }
    ...
    public function forward(Request $request, $id_tugas)
    {
        ...
        $role = $request->session()->get('role'); // mengambil role user yang sedang login

        $uuid = Uuid::uuid4()->toString(); // Buat UUID baru sebagai nilai id_penolakan

        $ket_tujuan = 'menunggu_konfirmasi'; // inisialisasi variabel keterangan tujuan
    ...
    public function tugas(Request $request)
    {
        ...
        return view('ah/tugas', compact('semuaTugasTeruskan', 'jumlahTugasTeruskan', 'semuaTugas', 'jumlahTugas', 'jumlahTugasMasuk', 'nama_pengguna', 'role', 'title'));
    }
    ...
    public function updatePerkembangan(Request $request, $id_tugas)
    {
        ...
        return view('ah/update-perkembangan-tugas', compact('tugas', 'riwayat_penerimaan', 'perkembangans', 'semuaTask', 'jumlahTugasMasuk', 'id_tugas', 'title', 'nama_pengguna', 'role'));
    }
    ...
    public function updateStatusRiwayatPenerimaan($id_tugas)
    {
        ...
        return redirect()->route('ah.tugas')->with('success', 'Tugas telah selesai. Semangat mengerjakan tugas berikutnya :)');
    }
}
