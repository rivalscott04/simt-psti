...
class DelegasiTugasKalab extends Controller
{
    ...
    public function tugasMasuk(Request $request)
    {
        ...
        if ($request->has('search')) {
            ...
            //         'riwayat_teruskans.nama_tujuan'
            //     )
            //     ->join('riwayat_teruskans', function ($join) use ($role, $request) {
            ...
            //     })
            //     ->where('tugas.perihal', 'like', '%' . $request->search . '%')
            //     ->orwhere('tugas.nama_pengirim', 'like', '%' . $request->search . '%')
            //     ->distinct()
        ...
        //Ambil jumlah tugas masuk
        $jumlahTugasMasuk = DB::table('tugas')
            ->select(
                'tugas.id_tugas',
                'tugas.user_id',
                'tugas.nama_pengirim',
    ...
    public function show(Request $request, Tugas $tugas)
    {
        ...
        return view('kl.show', compact('jumlahTugas', 'tugas', 'title', 'nama_pengguna', 'role', 'nama_hari', 'tanggal', 'jam'));
    }
    ...
    public function tugas(Request $request)
    {
        ...
        return view('kl/tugas', compact('semuaTugas', 'jumlahTugas', 'jumlahTugasMasuk', 'nama_pengguna', 'role', 'title'));
    }
    ...
    public function updatePerkembangan(Request $request, $id_tugas)
    {
        ...
        return view('kl/update-perkembangan-tugas', compact('perkembangans', 'semuaTask', 'jumlahTugasMasuk', 'id_tugas', 'title', 'nama_pengguna', 'role'));
    }
