...
class DelegasiTugasDosen extends Controller
{
    ...
    public function tugasMasuk(Request $request)
    {
        ...
        return view('d/tugas-masuk', compact('semuaTugasTeruskan', 'jumlahTugasTeruskan', 'semuaTugas', 'jumlahTugas', 'jumlahTugasMasuk', 'nama_pengguna', 'role', 'title', 'nama_pengirim'));
    }
    ...
    public function show(Request $request, Tugas $tugas)
    {
        ...
        return view('d.show', compact('jumlahTugasMasuk', 'tugas', 'title', 'nama_pengguna', 'role', 'nama_hari', 'tanggal', 'jam'));
    }
    ...
    public function tugas(Request $request)
    {
        ...
        return view('d/tugas', compact('semuaTugasTeruskan', 'jumlahTugasTeruskan', 'semuaTugas', 'jumlahTugas', 'jumlahTugasMasuk', 'nama_pengguna', 'role', 'title'));
    }
    ...
    public function updatePerkembangan(Request $request, $id_tugas)
    {
        ...
        return view('d/update-perkembangan-tugas', compact('tugas', 'riwayat_penerimaan', 'perkembangans', 'semuaTask', 'jumlahTugasMasuk', 'id_tugas', 'title', 'nama_pengguna', 'role'));
    }
    ...
    public function updateStatusRiwayatPenerimaan($id_tugas)
    {
        ...
        return redirect()->route('d.tugas')->with('success', 'Tugas telah selesai. Semangat mengerjakan tugas berikutnya :)');
    }
}