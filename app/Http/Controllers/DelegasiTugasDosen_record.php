...
class DelegasiTugasDosen extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        // $role = $request->input('matched_role'); // Ambil nilai dari request
        $role = $request->session()->get('role');
        // $role = session('current_role'); // Ambil peran dari sesi
        ...
        return view('d/delegasi-tugas', compact('semuaTugas', 'jumlahTugas', 'jumlahTugasMasuk', 'semuaTugasTeruskan', 'jumlahTugasTeruskan', 'nama_pengguna', 'role', 'title', 'alasan_penolakan'));
        // return view('d/delegasi-tugas', compact('semuaTugas', 'jumlahTugas', 'jumlahTugasMasuk', 'nama_pengguna', 'role', 'title', 'alasan_penolakan'));
    ...
    public function create(Request $request)
    {
        ...
        return view('d/tambah-delegasi-tugas', compact('title', 'nama_pengguna', 'role', 'jumlahTugasMasuk'));
    ...
    public function store(Request $request)
    {
        ...
        return redirect('d/delegasi-tugas')->with('success', 'Tugas berhasil didelegasikan');
    }
    ...
    public function edit(Request $request, $id_tugas)
    {
        ...
        return view('d/edit-delegasi-tugas', compact('jumlahTugasMasuk', 'tugas', 'title', 'nama_pengguna', 'role', 'jam', 'tanggalFormatted', 'perihal', 'tujuan'));
    }
    ...
    public function update(Request $request, $id_tugas)
    {
        ...
        return redirect()->route('d.edit', $tugas->id_tugas)->with('success', 'Tugas berhasil diperbarui!');
    }
    ...
    public function tugasMasuk(Request $request)
    {
        ...
        return view('d/tugas-masuk', compact('semuaTugas', 'jumlahTugas', 'jumlahTugasMasuk', 'nama_pengguna', 'role', 'title', 'nama_pengirim'));
    }
    ...
    public function show(Request $request, Tugas $tugas)
    {
        ...
        return view('d.show', compact('jumlahTugas', 'tugas', 'title', 'nama_pengguna', 'role', 'nama_hari', 'tanggal', 'jam'));
    }
    ...
    public function accept(Request $request, $id_tugas)
    {
        ...
        return redirect('d/tugas-masuk')->with('success', 'Tugas diterima!');
    }
    ...
    public function reject(Request $request, $id_tugas)
    {
        ...
        return redirect('d/tugas-masuk')->with('success', 'Tugas ditolak!');
    }
    ...
    public function forward(Request $request, $id_tugas)
    {
        ...
        return redirect('d/tugas-masuk')->with('success', 'Tugas diteruskan!');
    }
    ...
    public function tugas(Request $request)
    {
        ...
        return view('d/tugas', compact('semuaTugas', 'jumlahTugas', 'jumlahTugasMasuk', 'nama_pengguna', 'role', 'title'));
    }
    ...
    public function updatePerkembangan(Request $request, $id_tugas)
    {
        ...
        return view('d/update-perkembangan-tugas', compact('perkembangans', 'semuaTask', 'jumlahTugasMasuk', 'id_tugas', 'title', 'nama_pengguna', 'role'));
    }
    ...
    public function addTodoList(Request $request, $id_tugas)
    {
        ...
        return redirect()->route('d.updatePerkembangan', $tugas->id_tugas)->with('success', 'New task berhasil ditambahkan.');
        // return view('d.update-perkembangan-tugas')->with('success', 'New task berhasil ditambahkan.');
    }
    ...
    public function riwayatTugas(Request $request, $id_tugas)
    {
        ...
        return view('d/riwayat-tugas', compact('jumlahTugasMasuk', 'perkembangans', 'semuaRiwayat', 'title', 'nama_pengguna', 'role'));
    }
    ...
    public function perkembanganTugas(Request $request, $id_tugas)
    {
        ...
        return view('d/perkembangan-tugas', compact('id_tugas', 'jumlahTugasMasuk', 'title', 'nama_pengguna', 'role', 'semuaTask', 'perkembangans'));
    }
}
